...
import { win, getHostRef, styles, supportsConstructibleStylesheets, doc, plt, supportsShadowDom, consoleDevError, consoleDevWarn, isMemberInElement, consoleError, nextTick, writeTask, supportsListenerOptions, loadModule, registerHost, forceUpdate as forceUpdate$1, Context, readTask } from '@stencil/core/internal/platform';
let scopeId;
let contentRef;
let hostTagName;
let i = 0;
